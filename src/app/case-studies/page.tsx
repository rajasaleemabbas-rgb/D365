...
const caseStudies = [
  ...
  },
  {
    ...
    challenge: "A national distributor with an ERP uptime of 94%, a 4-hour average support response time, and $200K/year in emergency consulting fees for recurring system issues.",
